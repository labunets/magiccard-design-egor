...
const reasons = [
  {
    ...
    description: 'Сертифікат діє для всіх партнерськіх мереж. Вам не потрібно вгадувати смак чи підбирати подарунок індивідуально. Одержувач сам вирішує, на що використати сертифікат.',
  },
  {
    icon: encryptedIcon,
  ...
  },
  {
    ...
    description: 'Ви можете обрати дизайн електронного сертифіката. Оформлення легко адаптувати під стиль вашої компанії або конкретну подію.',
  },
  {
    icon: hourglassIcon,
    title: 'Тривалий термін дії',
    description: 'Сертифікати мають термін дії до 5 років. Одержувач не обмежений жорсткими дедлайнами і може скористатися подарунком у зручний для себе момент.',
  },
  {
  ...
  },
  {
    ...
    description: 'Єдиний сертифікат спрощує роботу бухгалтерії, логістики та операційних команд. Кінцеві користувачі не прив\'язані до однієї мережі й можуть розраховуватися в різних категоріях партнерськіх мереж.',
  },
  {
  ...
  },
  {
    ...
    description: 'Ви самостійно обираєте суму сертифіката залежно від завдання та бюджету. Доступні номінали легко масштабуються під різні формати подарунків.',
  },
  {
    icon: headphonesIcon,
    title: 'Професійна підтримка',
    description: 'Наша команда консультує клієнтів щодня з 10:00 до 18:00. MagicCard — платформа, що забезпечує регулярну та оперативну підтримку.',
  },
];
