...
- Footer та інші додаткові секції будуть додані пізніше
- Кнопки не мають повноцінних обробників подій (тільки локальний state в формі Certificate)
- Форма Certificate не підключена до backend API
